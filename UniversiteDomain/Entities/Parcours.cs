...
public class Parcours
{
    ...
    // Remarque : pour éviter quelques NullPointerException disgracieux, j'ai choisi de créer une liste d'incrits vide
    // quand aucun étudiant n'est inscrit dans un parcours plutôt que de l'initialiser à null
